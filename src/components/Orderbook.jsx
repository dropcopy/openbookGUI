...
import { useMarket, useOrderbook, useMarkPrice, useMarketInfos } from '../utils/markets';
...
export default function Orderbook({ smallScreen, depth = 7, onPrice, onSize }) {
  ...
  //const orderbook = useSelector((state) => state.openBookbook);
  ...
  return (
    <FloatingElement
      style={
        smallScreen ? { flex: 1 } : { height: '500px', overflow: 'hidden', backgroundColor: '#070a0a'}
      }
    >
